...
label_schemes: Dict[str, Dict[str, Union[int, float]]] = {
    "all": {
        "AP2": 0, "AP3": 1, "AP4": 2, "AP5": 3,
        "PLAX": 4, "RVIF": 5,
        "SUBC4": 6, "SUBC5": 7, "SUBIVC": 8,
        "PSAXAo": 9, "PSAXM": 10, "PSAXPM": 11, "PSAXAp": 12,
        "SUPRA": 13,
        "OTHER": 14,
        # "GARBAGE": 15,
    },
...
class_labels: Dict[str, List[str]] = {
    "all": ["AP2", "AP3", "AP4", "AP5", "PLAX", "RVIF", "SUBC4", "SUBC5", "SUBIVC",
            "PSAXAo", "PSAXM", "PSAXPM", "PSAXAp", "SUPRA", "OTHER"],
    "standard": ["AP2", "AP3", "AP4", "AP5", "PLAX", "RVIF", "SUBC4", "SUBC5", "SUBIVC",
            "PSAXAo", "PSAXM", "PSAXPM", "PSAXAp", "SUPRA"],
}
